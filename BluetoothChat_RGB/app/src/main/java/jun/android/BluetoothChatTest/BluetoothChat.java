...
public class BluetoothChat extends Activity {
    ...
    private void setupChat() {
        ...
        mEqbutton = (Button) findViewById(R.id.eq_button);
        mEqbutton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                sendMessage("e");
                sendMessage("e");
            }
        });
        mSolidbutton= (Button) findViewById(R.id.solid_button);
        mSolidbutton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                sendMessage("a");
                sendMessage("a");
            }
